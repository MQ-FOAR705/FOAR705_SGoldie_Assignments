...
\begin{frame}\label{\secvariable}
  ...
  %https://tex.stackexchange.com/a/7452/5483
  \begin{column}[c]{0.45\textwidth}
\includegraphics[width=1\textwidth,height=0.4\textheight,keepaspectratio]{figure/logo1.png}\\
\vspace{12pt}
\includegraphics[width=1\textwidth,height=0.4\textheight,keepaspectratio]{figure/figure1.png}
    \end{column}
    \begin{column}[c]{0.45\textwidth}
    \parbox{\linewidth}{
